...
constexpr Score kingAttackersWeight[5] = {S(0, 0), S(80, 80), S(52, 52),
                                          S(40, 40), S(10, 10)};
...
struct EvalWeights {
    ...
    const Score kingAttackersWeight[5] = {S(0, 0), S(80, 80), S(52, 52),
                                          S(40, 40), S(10, 10)};
};
...
constexpr Score Eval<T>::kingAttackers() {
    ...
    Bitboard kingArea = kingAttacks[kingSquare] & ~board.pieces(C);
