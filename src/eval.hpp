...
struct EvalWeights {
    const Score pawnScore = S(0, 0);
    const Score knightScore = S(0, 0);
    const Score bishopScore = S(0, 0);
    const Score rookScore = S(0, 0);
    const Score queenScore = S(0, 0);
    ...
    const Score kingAttackersWeight[7] = {S(0, 0), S(0, 0), S(0, 0), S(0, 0),
                                          S(0, 0), S(0, 0), S(0, 0)};
